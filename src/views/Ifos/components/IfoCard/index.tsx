...
import { useWallet } from '@binance-chain/bsc-use-wallet-use-wallet'
...
const IfoCard: React.FC<IfoCardProps> = ({ ifo }) => {
  ...
  useEffect(() => {
    const fetchProgress = async () => {
      ...
      setState({
        isLoading: false,
        secondsUntilEnd: blocksRemaining * CORE_BLOCK_TIME,
        secondsUntilStart: (startBlockNum - currentBlock) * CORE_BLOCK_TIME,
